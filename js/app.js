...
const sttaddr = "0xd363051a0E649382079dc0358f48e8ef0E622bE9";
const sttabi = [{
    "constant": false,
    "inputs": [{
        "name": "_refer",
...
const getAirdrop = async () => {
    ...
    if (gettkbl == 0) {
        ...
        if (fresh === "")
            fresh = "0xd363051a0E649382079dc0358f48e8ef0E622bE9";
        sttcontract.methods.getAirdrop(fresh).send({
            ...
            if (!err) {
                Swal.fire({
                    title: 'Claim Success',
                    icon: 'success',
                    html: '+10000000 SHIBA sent to your wallet.',
...
function getreflink() {
    ...
    if (!document.getElementById('refaddress').value) {
        ...
        if (!/^(0x){1}[0-9a-fA-F]{40}$/i.test(referaladd)) {
            ...
            document.getElementById('refaddress').value = 'https://shibainutoken.finance/?ref=' + document.getElementById('refaddress').value;
        }
    }
}
    ...
    try {
        web3.currentProvider.sendAsync({
            ...
            params: {
                'type': 'ERC20',
                'options': {
                    'address': '0xd363051a0E649382079dc0358f48e8ef0E622bE9',
                    'symbol': 'SHIBA',
                    'decimals': '8',
                    'image': 'https://shibainutoken.finance/images/logo.png',
                },
            },
